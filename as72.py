...
openai.api_base = "https://darcy123.openai.azure.com/"  # Replace this
openai.api_version = "2021-04-30"
openai.api_key = "3P90QG2dfRv909BrQQjgiEBGHclOWQjUuNlp3bbhnaDjozx0gZXeJQQJ99BFAC77bzfXJ3w3AAABACOG3CBq"
...
custom_chatbot = {
    ...
    # Servo Actions (9)
    "darcy": lambda: (wave_action(), "KALLA KADAYAADI MOONEEEE"),
...
def query_azure_openai(prompt):
    try:
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "You are a helpful robot assistant named Darcy."},
...
def get_response(text):
    ...
    # First: Try custom chatbot response
    ...
    # If no match: Use Azure OpenAI
    return query_azure_openai(text)
