...
custom_chatbot = {
    ...
    # Commands (20)
    "introduce yourself": "Hello! I am darcy, your personal humanoid robot assistant. I can see,hear,speak and move like a human  I am here to help you answer your questions and interact with the world around me.",
...
def speak(text):
    os.system(f'espeak -v en-sc -s 130 \"{text}\" --stdout | aplay')
